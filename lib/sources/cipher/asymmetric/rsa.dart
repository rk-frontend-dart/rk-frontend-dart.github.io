...
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/api/rsa.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/params/asymmetric_key_parameter.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/asymmetric/base_asymmetric_block_cipher.dart";
...
class RSAEngine extends BaseAsymmetricBlockCipher {
  ...
  void init(bool forEncryption, CipherParameters params) {
    ...
    AsymmetricKeyParameter<RSAAsymmetricKey> prm = params;
    _key = prm.key;
  }
  ...
  BigIntegerV8 _processBigInteger(BigIntegerV8 input) => input.modPow(_key.exponent, _key.modulus);
