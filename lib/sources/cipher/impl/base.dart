...
import "package:Lab_RekanKerjaku_FrontEnd/sources/bignum/bignum.dart";
// import "package:bignum/bignum.dart";

import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/adapters/stream_cipher_as_block_cipher.dart";
...
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/api/ecc.dart";
// import "package:cipher/api.dart";
// import "package:cipher/api/ecc.dart";

import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/asymmetric/rsa.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/asymmetric/pkcs1.dart";
// import "package:cipher/asymmetric/rsa.dart";
// import "package:cipher/asymmetric/pkcs1.dart";

import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/block/aes_fast.dart";
// import "package:cipher/block/aes_fast.dart";

import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/digests/md2.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/digests/md4.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/digests/md5.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/digests/ripemd128.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/digests/ripemd160.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/digests/ripemd256.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/digests/ripemd320.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/digests/sha1.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/digests/sha224.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/digests/sha256.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/digests/sha3.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/digests/sha384.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/digests/sha512.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/digests/sha512t.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/digests/tiger.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/digests/whirlpool.dart";
...
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/ecc/ecc_base.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/ecc/ecc_fp.dart" as fp;
// import "package:cipher/ecc/ecc_base.dart";
// import "package:cipher/ecc/ecc_fp.dart" as fp;

import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/key_derivators/pbkdf2.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/key_derivators/scrypt.dart";
// import "package:cipher/key_derivators/pbkdf2.dart";
// import "package:cipher/key_derivators/scrypt.dart";

import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/key_generators/ec_key_generator.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/key_generators/rsa_key_generator.dart";
// import "package:cipher/key_generators/ec_key_generator.dart";
// import "package:cipher/key_generators/rsa_key_generator.dart";

import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/macs/hmac.dart";
// import "package:cipher/macs/hmac.dart";

import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/modes/cbc.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/modes/cfb.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/modes/ecb.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/modes/gctr.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/modes/ofb.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/modes/sic.dart";
...
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/paddings/padded_block_cipher.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/paddings/pkcs7.dart";
// import "package:cipher/paddings/padded_block_cipher.dart";
// import "package:cipher/paddings/pkcs7.dart";

import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/random/auto_seed_block_ctr_random.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/random/block_ctr_random.dart";
// import "package:cipher/random/auto_seed_block_ctr_random.dart";
// import "package:cipher/random/block_ctr_random.dart";

import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/signers/ecdsa_signer.dart";
import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/signers/rsa_signer.dart";
// import "package:cipher/signers/ecdsa_signer.dart";
// import "package:cipher/signers/rsa_signer.dart";

import "package:Lab_RekanKerjaku_FrontEnd/sources/cipher/stream/salsa20.dart";
...
AsymmetricBlockCipher _pkcs1AsymmetricBlockCipherFactory(algorithmName) {
...
Digest _sha512tDigestFactory(algorithmName) {
...
Digest _sha3DigestFactory(algorithmName) {
...
KeyDerivator _pbkdf2KeyDerivatorFactory(algorithmName) {
...
PaddedBlockCipher _paddedBlockCipherFactory(algorithmName) {
...
SecureRandom _ctrPrngSecureRandomFactory( algorithmName ) {
...
SecureRandom _ctrAutoSeedPrngSecureRandomFactory( algorithmName ) {
...
Signer _ecdsaSignerFactory(algorithmName) {
  var sep = algorithmName.lastIndexOf("/");
...
StreamCipher _ctrStreamCipherFactory( algorithmName ) {
  var parts = algorithmName.split("/");
...
StreamCipher _sicStreamCipherFactory( algorithmName ) {
  var parts = algorithmName.split("/");
